 ...
 */
export function RegisterPartOne({
  firstName,
  setFirstName,
  lastName,
  setLastName,
  ...
  return (
    <div className="register-section-one">
      ...
      <h1 className="register-header">
        Make an account to plan your next hiking adventure and connect with
        friends.
      </h1>
...
export function RegisterPartTwo({
   ...
   */
  const REGISTER_URL = "https://gohike-api.herokuapp.com/authorization/register";
  /**
  ...
  return (
    <div className="register-section-two">
      ...
      {error ? (
        <p ref={errorRef} className="register-error" aria-live="assertive">
          {error}
        </p>
      ) : (
        ""
